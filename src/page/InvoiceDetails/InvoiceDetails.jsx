...
<Box sx={{display:'flex', justifyContent:'center', alignItems:'center', margin:'2rem 0rem', flexDirection:'column'}}>

<Typography variant='h1' sx={{fontSize:'2rem', fontWeight:'600'}}>Invoice Deatils</Typography>
